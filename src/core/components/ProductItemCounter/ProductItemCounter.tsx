  ...
  return (
    <div className='w-full flex align-items-center p-4'>
      <div className='flex flex-grow-1 flex-column'>
        ...
        <span className='font-medium text-primary text-lg'>{productItem.price} ₺</span>
      </div>
      <div id="buttons" className='flex flex-none bg-gray-100'>
        ...
        <span className='font-medium p-3 bg-primary text-white'>{Number(productItem.quantity)}</span>
