...
const Home = ({searchValue}:{searchValue:string}) => {
  ...
  return (
    <div className='w-full flex  md:justify-content-center pt-6 md:p-6' >

<div className=" flex w-full md:flex-row flex-column gap-1">
    <div style={{top:'68px'}}  className=" md:sticky h-min flex-grow-1 md:flex-none flex-column flex md:gap-4 w-full md:w-2">
